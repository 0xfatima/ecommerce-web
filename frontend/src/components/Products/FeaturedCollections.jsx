  ...
  return (
    <section className='py-16 px-4 lg:px-0'>
        ...
        rounded-lg'>
            ...
            <h2 className="text-lg font-semibold text-gray-700 b-2">
                Comfort and Style
            </h2>
            ...
            <p className='text-lg text-gray-600 mb-6'>
                Discover high-quality, comfortable cllothing that effortlessly blends  fashion and function. 
            ...
            <div className="lg:w-1/2">
                <img src="/featured.webp" alt="Featured Collection"
