        ...
        <form action="" className="" onSubmit={handleSubmit}>
          <div className="mb-4">
           ...
           <div className="mb-4">
            ...
            <input type="email" name="email" value={formData.email} onChange={handleChange} id=""
            className='w-full p-2 border rounded' />
          </div>
           ...
           <div className="mb-4">
            ...
            <input type="password" name="password" value={formData.password} onChange={handleChange} id=""
            className='w-full p-2 border rounded' />
          </div>
           ...
           <div className="mb-4">
            ...
            <select name="role" value={formData.role} className='w-full p-2 border rounded'
          ...
          <tbody>
            {users.map((user)=>(
              <tr key={user._id} className='border-b hover:bg-gray-50 '>
                ...
                <td className="p-4">
                  <select name="" value={user.role} id="" className="p-2 border rounded"
